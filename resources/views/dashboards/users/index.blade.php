...
<section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>Vacation manager</b></a>
            <!--logo end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="basic_table.html">Apply Vacation</a></li>
                          <li><a  href="responsive_table.html">Vacations History</a></li>
                      </ul>
                  </li>
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h1>Hello user, wecome to the vacation manager</h1>
                  </div>
